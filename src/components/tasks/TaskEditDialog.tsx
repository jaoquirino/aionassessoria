      ...
      >
        {isLoading ? (
          ...
          <div className="flex flex-col h-full max-h-[90vh] overflow-hidden">
            ...
            <ScrollArea className="flex-1 [&>[data-radix-scroll-area-viewport]]:!overflow-x-hidden [&_[style*='min-width']]:!min-w-0 [&_[style*='min-width']]:!display-block">
                  ...
                  {/* Attachments List */}
                   <div className="space-y-2 min-w-0 overflow-hidden">
                    {displayTask.attachments?.map((attachment) => (
                      <div
                        key={attachment.id}
                        className="flex items-center gap-2 p-3 rounded-lg border hover:bg-muted/50 transition-colors group cursor-pointer min-w-0"
                      >
                        <a
